...
def store_messages(m):
    """Handle occasional storing of all messages in the HDF5 store."""
...
message_data = (
    pd.read_excel(
        r'C:\Users\pinha\OneDrive\Documents\Trading\ml4t-code\02_market_and_fundamental_data\01_NASDAQ_TotalView-ITCH_Order_Book\message_types.xlsx',
        sheet_name='messages'
    )
    .sort_values('id')
    .drop('id', axis=1)
